...
# # Switch to dj_database_url when deploying on Railway
# DATABASES = {
#     'default': {
...
# === CORS SETTINGS (Critical for frontend to work) ===
CORS_ALLOW_CREDENTIALS = True
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost:3001",  # if feedback app is on 3001
    # Add deployed frontend later, e.g. "https://your-app.vercel.app"
]

# Allow all origins for local testing (remove in production)
# CORS_ALLOW_ALL_ORIGINS = True  # ← Uncomment temporarily if still blocked

# === CSRF SETTINGS (needed for DELETE/POST from frontend) ===
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:3000',
    'http://127.0.0.1:3000',
    'http://localhost:3001',
...
# Session & CSRF cookies for cross-origin
SESSION_COOKIE_SECURE = False  # ← False locally (True only in prod HTTPS)
